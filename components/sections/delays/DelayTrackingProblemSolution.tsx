...
const PAIN_POINTS = [
  "Delays recorded casually or not at all: no central register",
  "No link between delay and responsible party: proof is weak",
  "Cost impact guessed, not calculated: claims are lower than deserved",
  "Schedule comparison is manual: hard to prove cumulative impact",
];

export function DelayTrackingProblemSolution() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <motion.div variants={containerVariants} initial="hidden" animate={isInView ? "visible" : "hidden"} className="flex flex-col max-w-2xl">
            ...
            <motion.h2 variants={itemVariants} className="mb-6 text-balance font-display text-3xl font-bold tracking-tight text-text-primary sm:text-4xl md:text-5xl leading-tight">
              When it&apos;s time to claim, you&apos;ve got nothing.
            </motion.h2>

            <motion.p variants={itemVariants} className="mb-10 text-lg text-text-secondary leading-relaxed">
              Rain hits. Work stops for a day. You note it casually in email. A month later, a sub is late on delivery. No one documents the cost or who&apos;s responsible. At project end, you want to file a delay claim, but you&apos;ve got scattered emails and vague recollections: no defensible record.
            </motion.p>
              ...
              <div className="rounded-xl border border-border-subtle bg-surface/50 overflow-hidden flex flex-col gap-2 p-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="w-full">
                      <div className="flex justify-between items-center mb-1">
                        <span className="font-body text-[13px] font-semibold text-text-primary">Fwd: Rain delay</span>
                      ...
                      <span className="font-body text-[12.5px] text-text-secondary line-clamp-2">
                        &quot;Hey guys, raining pretty hard today. We sent the crew home. Might be behind on the pour.&quot;
                      </span>
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="bg-white rounded-xl border border-border p-4 shadow-sm transition-colors hover:border-error-border mt-2">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="font-body text-[13.5px] font-semibold text-text-primary block">Final Claim Review</span>
                      <span className="font-data text-[12px] text-error-text flex items-center gap-1 mt-1">
                        <SearchX className="h-3.5 w-3.5" /> Cannot prove schedule impact or cost.
                      </span>
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="text-center p-3 mt-1">
                  <span className="font-data text-[11px] font-bold uppercase tracking-wider text-error-text bg-error-bg px-3 py-1.5 rounded-full">$40K in unrecoverable costs</span>
                </motion.div>
