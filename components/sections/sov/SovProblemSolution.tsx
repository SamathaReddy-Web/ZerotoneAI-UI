...
const PAIN_POINTS = [
  "SOV lives in email drafts: version control is chaos",
  "Pay apps manually assembled: math errors are common",
  "Change orders don't automatically update SOV: manual updates miss details",
  "Owner delays payment because billing isn't clear: cash forecasting breaks",
];

export function SovProblemSolution() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <motion.div variants={containerVariants} initial="hidden" animate={isInView ? "visible" : "hidden"} className="flex flex-col max-w-2xl">
            ...
            <motion.h2 variants={itemVariants} className="mb-6 text-balance font-display text-3xl font-bold tracking-tight text-text-primary sm:text-4xl md:text-5xl leading-tight">
              Billing gets delayed. Disputes happen. Cash is unpredictable.
            </motion.h2>

            <motion.p variants={itemVariants} className="mb-10 text-lg text-text-secondary leading-relaxed">
              You create an Excel SOV and email it. Owner questions the breakdown. You revise in email drafts. When a CO comes in, you manually update the SOV. At month end, you assemble a pay app from multiple sources. Retainage math is error prone.
            </motion.p>
              ...
              <div className="rounded-xl border border-border-subtle bg-surface/50 overflow-hidden flex flex-col gap-2 p-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="w-full">
                      <div className="flex justify-between items-center mb-1">
                        <span className="font-body text-[13px] font-semibold text-text-primary">SOV_Final_v4_fixed.xlsx</span>
                      ...
                      <span className="font-body text-[12.5px] text-text-secondary line-clamp-2">
                        &quot;I noticed the retainage math on line 12 is off by a few hundred dollars. We can&apos;t approve this until you revise and resubmit the G702.&quot;
                      </span>
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="bg-white rounded-xl border border-border p-4 shadow-sm transition-colors hover:border-error-border mt-2">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="font-body text-[13.5px] font-semibold text-text-primary block">Payment Delayed</span>
                      <span className="font-data text-[12px] text-error-text flex items-center gap-1 mt-1">
                        <SearchX className="h-3.5 w-3.5" /> 15 days lost waiting on math corrections
                      </span>
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="text-center p-3 mt-1">
                  <span className="font-data text-[11px] font-bold uppercase tracking-wider text-error-text bg-error-bg px-3 py-1.5 rounded-full">Manual pay apps stall cashflow</span>
                </motion.div>
