...
const PAIN_POINTS = [
  "Concrete invoice hits QuickBooks two weeks after the pour: too late to course correct",
  "Mechanical sub is 30% over on labor hours and you had no idea",
  "Owner asks for a cost breakdown and you spend a day pulling it from three spreadsheets",
  "No committed cost view: POs and subcontracts aren't in your budget picture",
];

export function BudgetProblemSolution() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <motion.div variants={containerVariants} initial="hidden" animate={isInView ? "visible" : "hidden"} className="flex flex-col max-w-2xl">
            ...
            <motion.h2 variants={itemVariants} className="mb-6 text-balance font-display text-3xl font-bold tracking-tight text-text-primary sm:text-4xl md:text-5xl leading-tight">
              Stop discovering overruns at month end.
            </motion.h2>

            <motion.p variants={itemVariants} className="mb-10 text-lg text-text-secondary leading-relaxed">
              Most small GCs track job costs in QuickBooks, which tells you what was invoiced, not what&apos;s committed. By the time you see the problem, it&apos;s already a conversation with the owner.
            </motion.p>
              ...
              <div className="rounded-xl border border-border-subtle bg-surface/50 overflow-hidden flex flex-col gap-2 p-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="w-full">
                      <div className="flex justify-between items-center mb-1">
                        <span className="font-body text-[13px] font-semibold text-text-primary">Q3_Budget_Final_v2.xlsx</span>
                      ...
                      <span className="font-body text-[12.5px] text-text-secondary line-clamp-2">
                        &quot;Wait, why is the steel code $25k over budget? We approved that change order three weeks ago but it&apos;s not in here...&quot;
                      </span>
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="bg-white rounded-xl border border-border p-4 shadow-sm transition-colors hover:border-error-border mt-2">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="font-body text-[13.5px] font-semibold text-text-primary block">Month-End Surprise</span>
                      <span className="font-data text-[12px] text-error-text flex items-center gap-1 mt-1">
                        <SearchX className="h-3.5 w-3.5" /> Profit margin wiped out by unrecorded commitments
                      </span>
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="text-center p-3 mt-1">
                  <span className="font-data text-[11px] font-bold uppercase tracking-wider text-error-text bg-error-bg px-3 py-1.5 rounded-full">Invoices tell you yesterday&apos;s news</span>
                </motion.div>
